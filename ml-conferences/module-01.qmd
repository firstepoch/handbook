...
Journals are the traditional way for researchers to share scientific knowledge (with notable examples including *Nature* and *Science*).[^journals]

[^journals]: In most scientific fields, the archival record lives in journals. Computer science is unusual in treating conference proceedings as the primary, prestigious publication venue.
...
- **Review Process**: papers are reviewed and scored, often giving authors a chance to respond (*rebuttal*).[^rebuttal]

[^rebuttal]: A short author response to reviewer comments, written before the final accept/reject decision. We cover how to write one in [1.5 Writing a Rebuttal](module-05.qmd).
